...
const ChefDetails = ({ chef }) => {
  ...
  // useEffect(() => {
  //   fetch("https://petuk-bengali-cuisine-server-taniaferdousey24promy.vercel.app/chefs")
  //     .then((res) => res.json())
          ...
          <Card className="text-start">
            ...
            <Card.Body>
              <span className="d-flex">
                ...
                <span className="text-success fs-5 fw-bold ms-5 ">
                  MAIN DISH
                </span>
              </span>
              ...
              <Card.Text className="fw-semibold">
                {" "}
                <span>
                  <p className="fs-4">Ingredients:</p>
                </span>{" "}
                <span>{chefDetails.recipes[0].ingredients[0]} </span>,{" "}
                <span>{chefDetails.recipes[0].ingredients[1]} </span>,{" "}
                <span>{chefDetails.recipes[0].ingredients[2]} </span> ,{" "}
                <span>{chefDetails.recipes[0].ingredients[3]} </span>,
                <span>{chefDetails.recipes[0].ingredients[4]} </span>
              </Card.Text>
              <Card.Text className="fw-semibold">
                {" "}
                <span>
                  {" "}
                  <p className="fs-4">Cooking Method: </p>{" "}
                  {chefDetails.recipes[0].cooking_method}
                </span>{" "}
              </Card.Text>
            </Card.Body>
          </Card>
          <Card className="ms-5 border-start text-start">
            ...
            <Card.Body>
              ...
              <Card.Text className="fw-semibold">
                ...
                <span>{chefDetails.recipes[1].ingredients[0]} </span>,{" "}
                <span>{chefDetails.recipes[1].ingredients[1]} </span>,{" "}
                <span>{chefDetails.recipes[1].ingredients[2]} </span> ,{" "}
                <span>{chefDetails.recipes[1].ingredients[3]} </span>,
                <span>{chefDetails.recipes[1].ingredients[4]} </span>
              </Card.Text>
              <Card.Text className="fw-semibold">
                {" "}
                <span>
                  {" "}
                  <p className="fs-4">Cooking Method: </p>{" "}
                  {chefDetails.recipes[1].cooking_method}
                </span>{" "}
              </Card.Text>
            </Card.Body>
          </Card>
          <Card className="ms-5 border-start text-start">
            ...
            <Card.Body>
              ...
              <Card.Text className="fw-semibold">
                ...
                <span>{chefDetails.recipes[2].ingredients[0]} </span>,{" "}
                <span>{chefDetails.recipes[2].ingredients[1]} </span>,{" "}
                <span>{chefDetails.recipes[2].ingredients[2]} </span> ,{" "}
                <span>{chefDetails.recipes[2].ingredients[3]} </span>,
                <span>{chefDetails.recipes[2].ingredients[4]} </span>
              </Card.Text>
              <Card.Text className="fw-semibold">
                {" "}
                <span>
                  {" "}
                  <p className="fs-4">Cooking Method: </p>{" "}
                  {chefDetails.recipes[2].cooking_method}
                </span>{" "}
              </Card.Text>
            </Card.Body>
          </Card>
